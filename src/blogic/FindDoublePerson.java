 ...
 */
public class FindDoublePerson extends AbstractTableModel {

    private ArrayList<BookingPerson> checkArray = null;
    private ArrayList<BookingPerson> doubleArray = new ArrayList<>();

    public FindDoublePerson(ArrayList<BookingPerson> checkArray) {
...
//                System.out.println("i = " + i + " Svnum " + checkArray.get(i).getCheckinn() + " equals ==>> j = " + j + " Svnum " + checkArray.get(j).getCheckinn());
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        BookingPerson p = doubleArray.get(rowIndex);
        Object ret = null;
        switch (columnIndex) {
            case 0: //"ID"
                ret = p.getId();
