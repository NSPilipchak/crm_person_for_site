 ...
 */
public class EntityR03 implements Comparable<EntityR03> {
    private String id_;
    ...
    public EntityR03(String id_, String parentname, String passportnum,
    ...
    @Override
    public int compareTo(EntityR03 o) {
